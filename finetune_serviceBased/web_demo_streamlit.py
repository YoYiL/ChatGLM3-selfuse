...
#MODEL_PATH = os.environ.get('MODEL_PATH', 'G:\\ChatGLM3\\chatglm3-6b')
...
model, tokenizer = load_model_and_tokenizer('G:\\ChatGLM3\\finetune_serviceBased\\output\\checkpoint-3000')
